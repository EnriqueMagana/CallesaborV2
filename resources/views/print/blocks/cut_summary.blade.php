...
<section class="ticket-cut">
    ...
    <div class="ticket-row"><span>Apertura</span><span>{{ $cut->cashRegister->opened_at->format('d/m/Y H:i') }}</span></div>
    <div class="ticket-row"><span>Cierre</span><span>{{ $cut->generated_at->format('d/m/Y H:i') }}</span></div>
