                ...
                <div class="reservation-modal__body">
                    ...
                    <form id="reservation-customer-form" wire:submit="submit" class="reservation-panel reservation-details" x-show="step === 3" x-cloak x-transition.opacity.duration.180ms>
                        ...
                        <div class="reservation-fields">
                            ...
                            <label><span>Ocasión</span><div><i class="bx bx-gift" aria-hidden="true"></i><select wire:model="occasion"><option value="">Visita casual</option><option>Cumpleaños</option><option>Aniversario</option><option>Reunión familiar</option><option>Reunión de trabajo</option><option>Otra celebración</option></select></div></label>
