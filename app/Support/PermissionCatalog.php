    ...
    public static function definitions(): array
    {
        return [
            'punto_venta' => [
                ...
                'aplicar descuentos' => 'Permite identificar a un empleado o asociado durante el cobro y aplicar automáticamente los descuentos de personal que le correspondan.',
            ...
            'descuentos' => [
                'ver descuentos' => 'Permite consultar las reglas automáticas de descuento, su vigencia, audiencia, productos y estado.',
                'crear descuentos' => 'Permite crear descuentos automáticos por porcentaje o monto fijo para público, clientes o personal.',
                'editar descuentos' => 'Permite modificar, activar o pausar reglas de descuento y cambiar su elegibilidad.',
                'eliminar descuentos' => 'Permite eliminar reglas de descuento; las ventas realizadas conservan la evidencia histórica aplicada.',
            ],
            'ordenes' => [
                ...
                'solicitar cambio de metodo de pago' => 'Permite solicitar que un cobro delivery registrado con el método equivocado se reclasifique como efectivo, tarjeta o transferencia; no crea otro pago ni lo aplica sin aprobación.',
                'solicitar cambio de direccion' => 'Permite solicitar una nueva dirección, colonia, referencias y teléfono para un delivery activo; el destino no cambia hasta que owner o super-admin lo aprueben.',
                'revisar solicitudes de ordenes' => 'Permite abrir la bandeja exclusiva y aprobar o rechazar cancelaciones, modificaciones, cambios de pago y cambios de dirección; está reservado al owner y al super-admin.',
            ...
            'delivery' => [
                ...
                'reasignar pedidos delivery' => 'Permite consultar los repartidores del turno y transferir un pedido ya asignado a otro repartidor, indicando un motivo y conservando la trazabilidad.',
